...
namespace MyWebAppMVC.Data.Migrations
{
    ...
    [Migration("20260304225501_Products_model")]
    partial class Products_model
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyWebAppMVC.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyWebAppMVC.Models.Product", b =>
                {
                    b.HasOne("MyWebAppMVC.Models.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyWebAppMVC.Models.Supplier", "Supplier")
                        .WithMany("Products")
